...
BASELINE = "e185e592ef5d02b6fd5d2ce65888591bea32ed27"
...
EXPECTED_MANIFEST_BLOB = "5ec35e0783423a7fa9522df8a643232f7f8bd70b"
...
def integrity_audit(repo: Path, source_root: Path, final_html: str, driver, out_json: Path) -> dict:
    ...
    superseded_plate_restored = sorted(set(pid for pid in SUPERSEDED_PLATE_IDS if pid in plates))
    ...
    report = {
        ...
        "rejected_or_superseded_plate_restoration_count": len(rejected_restored) + len(superseded_plate_restored),
        "rejected_or_superseded_plate_restoration": rejected_restored + superseded_plate_restored,
...
def preflight(repo: Path, out: Path) -> int:
    ...
    checks = [
        branch == "audit/phase-b2-rerun-20260918",
