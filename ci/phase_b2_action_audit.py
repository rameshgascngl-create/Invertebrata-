...
BASELINE = "d840590d8a045c035f95487d8b956eb0e992260a"
...
EXPECTED_MANIFEST_BLOB = "92270e415b29662a827efffc6744896e869f13b0"
...
EXPECTED_STEP2_BLOB = "35f288d6c30d98816140d08f7e8b20aa09522bf5"

AUDIT_ALLOWED_DIFFS = {
    ".github/workflows/phase-b2-authoritative-rerun.yml",
    "ci/phase_b2_action_audit.py",
    "ci/phase_b2_render_shard.py",
    "ci/phase_b2_aggregate_audit.py",
}
...
def preflight(repo: Path, out: Path) -> int:
    ...
    checks = [
        branch == "audit/phase-b2-authoritative-rerun-20260919",
        ...
        step2_blob == EXPECTED_STEP2_BLOB,
