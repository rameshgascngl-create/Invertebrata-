...
def main(root):
 ...
 # Master specimens are style-refined variants of existing requirements, not four new academic requirements.
 specs=[
 ...
 for r in rows:
  if r.get('SVG Identifier/File','').startswith('master-'): continue
 ...
 print('V188_PENCIL_MASTER_VARIANTS=4'); print('V188_MASTER_VARIANTS_COUNT_AS_NEW_REQUIREMENTS=NO'); print('V188_VISUAL_PROVENANCE_FIELDS=3'); print('V188_BUILD_TRIGGERED=NO'); print('V188_BUILD_ELIGIBLE=NO')
