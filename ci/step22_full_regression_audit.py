...
async def main_async(args):
 ...
 with (out/'STEP21_PRECONDITION_DESTINATIONS.csv').open('w',newline='',encoding='utf-8') as f:w=csv.DictWriter(f,fieldnames=list(pre[0]));w.writeheader();w.writerows(pre)
 with (out/'STEP21_POSTCONDITIONS.csv').open('w',newline='',encoding='utf-8') as f:w=csv.DictWriter(f,fieldnames=list(post[0]));w.writeheader();w.writerows(post)
